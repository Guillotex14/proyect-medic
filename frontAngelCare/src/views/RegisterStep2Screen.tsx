          ...
          !nextStep && !nextStep2 &&(
            <>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <View style={{ ...styles.input ,width: '25%', backgroundColor: 'white', borderColor: '#B3B8C9', borderRadius: 12, marginTop: 15, marginLeft: 20 }}>
                    <TouchableOpacity onPress={() => setShowTypeDNI(true)}>
                      <TextInput value={typeDNISelected} editable={false} style={{width: 80, height: 50, marginLeft: 20, textAlign: 'left', color: '#000'}}/>
              ...
              <View style={{width: '100%', alignSelf: 'center', marginTop: 30}}>
                ...
                <TextInput placeholder="Fecha de nacimiento" style={{...styles.input, backgroundColor: 'white', marginLeft: 15}} value={birthDate} onChangeText={setBirthDate} onFocus={handleFocus} onBlur={handleBlur}/>
                </Pressable>
              ...
              <TouchableOpacity style={{...styles.button, marginTop: 40, marginHorizontal: 40, marginBottom: 24}} onPress={()=> setNextStep(true)}>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center', marginTop: top+50, justifyContent: 'center'}}>
                ...
                <View style={{alignItems: 'center', marginHorizontal: 10, marginTop: top+20, marginBottom: 30}}>
                  <FormControl style={{marginVertical: 5}}>
                    ...
                    numberOfLines={6}
                    maxLength={240}
                    style={{padding: 10, backgroundColor: 'white', borderRadius: 10, width: '90%', borderColor: 'gray', borderWidth: 1, marginHorizontal: 10, marginVertical: 5, textAlignVertical: 'top'}}
