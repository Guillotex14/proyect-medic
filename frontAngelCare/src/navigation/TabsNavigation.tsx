...
export const TabsNavigation = () => {
    ...
    return (
      <Tabs.Navigator screenOptions={
        ...
        <Tabs.Screen name="TabDatesHistorial" component={StackDatesHistorial} options={{
          // eslint-disable-next-line react/no-unstable-nested-components
          tabBarIcon: () => (
        ...
        <Tabs.Screen name="Services" component={StackServices} options={{
          // eslint-disable-next-line react/no-unstable-nested-components
          tabBarIcon: () => (
        ...
        <Tabs.Screen name="TabProfile" component={StackProfile} options={{
          // eslint-disable-next-line react/no-unstable-nested-components
          tabBarIcon: () => (
...
export const TabsNavigationDoctor = () => {
  ...
  return (
    <Tabs.Navigator screenOptions={
      ...
      <Tabs.Screen name="HomeDoctor" component={HomeDoctorScreen} options={{
        // eslint-disable-next-line react/no-unstable-nested-components
        tabBarIcon: () => (
          <Image source={Images.grids} style={{width: 25, height: 25, alignSelf: 'center'}}/>
        ),
