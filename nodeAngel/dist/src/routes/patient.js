...
patientRouter.get("/allMedics", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const myMedics = yield medics_1.default.aggregate([
        {
            $match: query
        },
        {
...
patientRouter.get("/getDates", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const jsonRes = new response_1.RespondesModel();
    const { id_patient } = req.query;
    const query = {
        id_patient: new mongoose_1.default.Types.ObjectId(`${id_patient}`),
    };
...
patientRouter.get("/lastDate", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const jsonRes = new response_1.RespondesModel();
    const { id_patient } = req.query;
    const query = {
        id_patient: new mongoose_1.default.Types.ObjectId(`${id_patient}`),
